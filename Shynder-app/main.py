...
async def register(username:str, ddescription:str, course:str, full_name:str, email:str, ppassword:str, test_results:str = ""):
    ...
    user = schemas.UserCreate(username=username, ddescription=ddescription, course=course, full_name=full_name, email=email, ppassword=hash_bcr(ppassword), test_results=test_results)
